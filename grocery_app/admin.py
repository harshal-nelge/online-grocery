...
admin.site.site_header = "QuickGrocer Admin"
admin.site.site_title = "QuickGrocer Admin Portal"
admin.site.index_title = "Welcome to QuickGrocer Admin Portal"
...
class ProductAdmin(admin.ModelAdmin):
    list_display = ['name', 'category', 'price', 'stock', 'display_image']
