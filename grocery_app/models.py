...
# Add this to grocery_app/models.py after the OrderItem model

class ProductRecommendation(models.Model):
    """Model to store product recommendations relationships"""
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name='source_recommendations')
